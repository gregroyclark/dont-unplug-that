...
internal val logger: SkipLogger = SkipLogger(subsystem = "dont.unplug.that", category = "DontUnplugThat")

private typealias AppRootView = DontUnplugThatRootView
private typealias AppDelegate = DontUnplugThatAppDelegate
